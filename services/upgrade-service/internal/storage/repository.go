...
type Repository interface {
	...
	ListReleases(context.Context) ([]domain.ReleaseVersion, error)
	ListDeployments(context.Context) ([]domain.DeploymentRecord, error)
	ListSwitchEvents(context.Context) ([]domain.SwitchEvent, error)
	ListRollbackEvents(context.Context) ([]domain.RollbackEvent, error)
